...
#if canImport(tempo_tx_ffiFFI)
import tempo_tx_ffiFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_tempo_tx_ffi_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_tempo_tx_ffi_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureTempoTxFfiInitialized()
 ...
 */
public func buildCloseTransaction(chainId: UInt64, nonce: UInt64, maxFeePerGas: String, maxPriorityFeePerGas: String, gasLimit: UInt64, feeToken: Data?, privateKey: Data, escrow: Data, channelId: Data, cumulativeAmount: String, voucherSignature: Data)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeFfiError_lift) {
    uniffi_tempo_tx_ffi_fn_func_build_close_transaction(
        ...
        FfiConverterString.lower(cumulativeAmount),
        FfiConverterData.lower(voucherSignature),$0
    )
})
}
/**
 ...
 */
public func buildSubscriptionChargeTransaction(chainId: UInt64, nonce: UInt64, maxFeePerGas: String, maxPriorityFeePerGas: String, gasLimit: UInt64, feeToken: Data?, privateKey: Data, rootAddress: Data, currency: Data, recipient: Data, amount: String, memo: Data, keyAuthorization: Data?, feePayerPrivateKey: Data?)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeFfiError_lift) {
    uniffi_tempo_tx_ffi_fn_func_build_subscription_charge_transaction(
        ...
        FfiConverterOptionData.lower(keyAuthorization),
        FfiConverterOptionData.lower(feePayerPrivateKey),$0
    )
})
}
/**
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_tempo_tx_ffi_uniffi_contract_version()
    ...
    if (uniffi_tempo_tx_ffi_checksum_func_build_subscription_charge_transaction() != 19757) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureTempoTxFfiInitialized() {
